...
//        use the xmpp host and port connection the xmpp server
    ...
    private void submitRegisterTask() {
        ...
        submitConnectTask();
        // use newRandomUUID gen the username and password to register xmpp server
    ...
    private void submitLoginTask() {
        ...
        submitRegisterTask();
        // use the register username and password ,resource name login xmpp server
...
//                add packet listener uer packet filter
